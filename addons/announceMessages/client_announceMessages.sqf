...
[
["This server supports JSRS Dragonfyre, Blastcore Phoenix, VTS Weapon Resting, Fullscreen NVGs, Shacktack Fireteam HUD and Midrange Texture replacement Pack Client mods - visit us on http://www.gamersinc.co.za for more info!", 2100], 
["Looking for an admin? Contact us on teamspeak - ts.gamersinc.co.za", 600],
...
["This server auto restarts every 4 hours to ensure optimal client performance !", 3600]
];
