...
switch (true) do {			
			case (_uid in _copper):
		{
			...
			for "_i" from 1 to 3 do {_player addItemToUniform "9Rnd_45ACP_Mag";};
			...
			for "_i" from 1 to 3 do {_player addItemToBackpack "RPG32_F";};
			...
			_player addWeapon "Laserdesignator_02";
			_player addItem "FirstAidKit";
			_player addItem "FirstAidKit";
			_player addGoggles "G_Bandanna_beast";
			_player addHeadgear "H_PilotHelmetFighter_B";
			_player setObjectTextureGlobal  [0, "client\images\vehicleTextures\pinkcamo.jpg"]; 
			...
			case (_uid in _bronze):
		{
			...
			_player addVest "V_PlateCarrierIAGL_dgtl";
			_player forceAddUniform "U_O_FullGhillie_sard";
			for "_i" from 1 to 3 do {_player addItemToUniform "HandGrenade";};
...
//			_player setObjectTextureGlobal  [0, "client\images\vehicleTextures\greycamo.jpg"]; 
...
//			_player addGoggles "G_Bandanna_beast";
			_player addHeadgear "H_CrewHelmetHeli_B";
//			_player setObjectTextureGlobal  [0, "client\images\vehicleTextures\greencamo.jpg"];  
		...
		case (_uid in _platinum1): // V o o D o o
		{
			...
			_player addItemtoVest "FirstAidKit";
			_player addItemtoVest "FirstAidKit";
			_player addItemtoBackPack "optic_nightstalker";
			_player addGoggles "G_Bandanna_beast";
			_player addHeadgear "H_PilotHelmetFighter_B";
			_player setObjectTextureGlobal  [0, "client\images\vehicleTextures\digicamo.jpg"];
			systemChat format["Welcome %1, You have a Platinum Supporter Loadout!", name player];
